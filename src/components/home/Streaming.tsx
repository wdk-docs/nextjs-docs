export function Streaming() {
  ...
  const style3 = {
    animation: "1s ease 0.8s 1 normal forwards running dash",
  };
  const style4 = {
    animation: "1s ease 0s 1 normal forwards running dash",
  };
  const style5 = {
    animation: "1s ease 0.8s 1 normal forwards running dash",
  };
  ...
  return (
    <div className="flex items-center justify-center w-full select-none h-52 group">
      <svg
        ...
        style={style1}
      >
        <mask id="mask0_113_97" style={style2} width="337" height="188" x="0" y="0" maskUnits="userSpaceOnUse">
          <path fill="#000" d="M0 0H337V188H0z"></path>
        </mask>
        <defs>
          <linearGradient id="pulse-gradient" x1="2" x2="0" y1="0" y2="1">
            <stop offset="0%" stopColor="rgba(0,122,255,0)"></stop>
        ...
        <circle cx="89" cy="92" r="10" className="fill-white dark:hidden"></circle>
        <path
        ...
        ></path>
        <circle cx="105" cy="91.5" r="3" fill="#007aff" className="origin-center animate-ping"></circle>
        <circle
          cx="105"
          cy="91.5"
          r="3"
          className="transition-all duration-300 origin-center fill-blue-500 group-hover:fill-green-500 group-hover:scale-125"
        ></circle>
        <circle cx="89" cy="59" r="10" className="fill-white dark:hidden"></circle>
        <path
          className="stroke-black dark:stroke-neutral-200"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        ></path>
        <circle cx="105" cy="59.5" r="3" fill="#007aff" className="origin-center animate-ping"></circle>
        <circle
          cx="105"
          cy="59.5"
          r="3"
          className="transition-all duration-300 origin-center fill-blue-500 group-hover:fill-green-500 group-hover:scale-125"
        ></circle>
        <circle cx="153" cy="75.5" r="3" fill="#007aff" className="origin-center animate-ping"></circle>
        <circle
          cx="153"
          cy="75.5"
          r="3"
        ...
        ></path>
        <mask id="mask1_113_97" style={style7} width="337" height="188" x="0" y="0" maskUnits="userSpaceOnUse">
          <path fill="url(#paint0_radial_113_97)" d="M0 0H337V188H0z"></path>
        </mask>
        <g mask="url(#mask1_113_97)">
          <circle cx="168.5" cy="629.5" r="491.5" fill="#F2F2F2" className="dark:fill-neutral-900"></circle>
          <circle
            cx="168.5"
            cy="629.5"
            r="491"
