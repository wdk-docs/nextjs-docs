---
title: 从Vite迁移
description: 了解如何将现有的React应用程序从Vite迁移到Next.js。
---

本指南将帮助您将现有 Vite 应用程序迁移到 Next.js。
...
> **很高兴知道:** You can use either `.js` or `.mjs` for your Next.js configuration file.
...
> **很高兴知道**: `.js`, `.jsx`, or `.tsx` extensions can be used for Layout files.
...
> **很高兴知道**: `.js`, `.jsx`, or `.tsx` extensions can be used for Page files.
