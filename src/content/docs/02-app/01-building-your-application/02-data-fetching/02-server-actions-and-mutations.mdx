...
> **Good to know:** 我们不建议仅依靠加密来防止敏感值在客户端上暴露。相反，您应该使用[React taint APIs](/docs/app/building-your-application/data-fetching/patterns#preventing-sensitive-data-from-being-exposed-to-the-client)来主动防止特定数据发送到客户端。
...
> **Good to know:** 部署到 Vercel 的 Next.js 应用程序会自动处理此问题。
